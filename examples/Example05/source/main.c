...
int main(int argc, char *argv[])
{
    ...
    // Set-up dual screen mode. Beware!!! It will eat up 2 whole banks (C-D) and
    // force your game to run at 30 fps!
    ...
    while (1)
    {
        ...
        if (ulGetMainLcd())
        {
            ...
            ulDrawGradientRect(0, 0, 256, 192, RGB15(31, 0, 0), RGB15(0, 0, 0),
        ...
        else
        {
            ...
            ulDrawGradientRect(0, 0, 256, 192, RGB15(0, 0, 0), RGB15(0, 0, 31),
                               RGB15(0, 0, 31), RGB15(0, 0, 0));
