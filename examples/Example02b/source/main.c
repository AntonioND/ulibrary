...
// Our image contains 3 frames, one next to the other vertically, and 32 pixel
// wide.
...
int main(int argc, char *argv[])
{
    ...
    ulSetTransparentColor(RGB15(31, 0, 31));
    {
        ...
        imgJames = ulLoadImageFilePNG((void *)james_png, (int)james_png_size,
    ...
    while (1)
    {
        ...
        ulDrawGradientRect(0, 0, 256, 192, RGB15(0, 0, 0), RGB15(0, 24, 0),
                           RGB15(0, 24, 0), RGB15(0, 0, 0));
        ...
        ulSetImageTileSize(imgJames,
            ...
            // Top position: animPositions defines the frame numbers in the
            // image for each animation step (0, 1, 2, 1). Each frame is
            // FRAME_HEIGHT tall, so we just have to multiply to get the actual
            // position of the frame on the image!
