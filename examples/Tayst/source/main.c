...
int main(int argc, char *argv[])
{
    ...
    {
        // We load our logo. Note that the format is PAL5_A3 (32 colors). It is
        // enough for our image but may not for others.
        imgTails = ulLoadImageFilePNG((void *)tails_png, (int)tails_png_size,
    ...
    while (1)
    {
        ...
        ulDrawGradientRect(0, 0, 256, 192, RGB15(0, 0, 31), RGB15(0, 16, 31),
                           RGB15(0, 16, 31), RGB15(0, 31, 31));
