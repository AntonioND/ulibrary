...
{
    // Draw a background
    ulDrawGradientRect(0, 0, 256, 144, RGB15(31, 24, 13), RGB15(31, 24, 13),
                       RGB15(31, 28, 22), RGB15(31, 28, 22));
    ...
    // Print the memory currently usage out of the total number of objects
    // possible on the screen at once
...
int main(int argc, char *argv[])
{
    ...
    imgMountains = ulLoadImageFilePNG((void *)mountains_png, (int)mountains_png_size,
                                      UL_IN_RAM, UL_PF_PAL4);
    ...
    while (1)
    {
        ...
        if (ul_keys.touch.click)
        {
            ...
            // Note the Render argument: this function will be called from
            // within ulMessageBoxEx to render the background image!
            ulMessageBoxEx("Welcome!\n"
                           "This is a message box, you can move it, touch the "
                           "buttons or press the corresponding keys.", "Hello!",
                           2, buttons, Render, 0);
        }
