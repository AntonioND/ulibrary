/// @file VirtualFile.h
///
/// @brief Virtual File support for 無ibrary.
///
...
//
// Done by default by 無ibrary, so there is no need to call it by yourself.
...
///
/// Automatically registered when initializing 無ibrary.
