                        ...
                        int palCount)
{
    ...
    if (img)
    {
        ...
        // The height doesn't have to be rounded to a power of two,
        // ulTexImage2D() will do the job to create a texture which is big
        // enough but where only a part of data are actually used.
